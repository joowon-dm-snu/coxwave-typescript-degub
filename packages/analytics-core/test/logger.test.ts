...
describe('logger', () => {
  ...
  describe('log', () => {
    test('should log event', () => {
      ...
      expect(log).toHaveBeenCalledWith('Coxwave Logger [Log]: Success');
    });
  ...
  describe('warn', () => {
    test('should log event', () => {
      ...
      logger.warn('Success');
      expect(log).toHaveBeenCalledTimes(1);
      expect(log).toHaveBeenCalledWith('Coxwave Logger [Warn]: Success');
    });
  ...
  describe('error', () => {
    test('should log event', () => {
      ...
      expect(log).toHaveBeenCalledTimes(1);
      expect(log).toHaveBeenCalledWith('Coxwave Logger [Error]: Success');
    });
  ...
  describe('debug', () => {
    test('should log event', () => {
      ...
      expect(log).toHaveBeenCalledTimes(1);
      expect(log).toHaveBeenCalledWith('Coxwave Logger [Debug]: Success');
    });
